...
return (
    ...
    <button
        ...
        >
        <Icon
            className="series-modal__close-icon"
            name="close"
        />
        </button>
        ...
        <dl className="series-modal__metadata">
            ...
            <dt className="series-modal__metadata-label">
                Calificación
            </dt>

            <dd
                className="
                series-modal__metadata-value
                series-modal__metadata-value_type_rating
                "
            >
            <Icon
                className="series-modal__rating-icon"
                name="star"
            />
          ...
          {show.url && (
            ...
            >
              ...
              <Icon
                className="series-modal__source-icon"
                name="external-link"
              />
            </a>
          )}
